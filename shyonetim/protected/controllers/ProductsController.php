...
class ProductsController extends Controller
{
	...
	public function actionBottomadd(){
		if(isset($_POST))
		{
			...
			$modelProductbottoms->productsID= $_POST["productsID"];
			
			$STR="";
			if(isset($_POST["bottomvalue1"])){
				$modelProductbottoms->bottomvalue1= $_POST["bottomvalue1"];
			...
			if(isset($_POST["bottomvalue7"])){
				...
				$modelProductbottoms->stok= $_POST["stok"];
				$modelProductbottoms->warehouseID= $_POST["warehouseID"];
